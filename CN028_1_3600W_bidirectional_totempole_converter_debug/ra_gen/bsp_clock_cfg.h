...
#define BSP_CFG_PLL2_MUL BSP_CLOCKS_PLL_MUL_25_0 /* PLL2 Mul x25.0 */
...
#define BSP_CFG_GPTCLK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_PLL2) /* GPTCLK Src: PLL2 */
#define BSP_CFG_IICCLK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_PLL2) /* IICCLK Src: PLL2 */
